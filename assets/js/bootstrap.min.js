...
!(function (t, e) {
                      ...
                      return function i(n) {
                          ...
                          for (let { target: r } = n; r && r !== this; r = r.parentNode)
                              for (let a = o.length; a--; )
                                  if (o[a] === r)
                                      return (n.delegateTarget = r), i.oneOff && B.off(t, n.type, e, s), s.apply(r, [n])
                          return null
                      }
                  })(t, s, i)
                : (function (t, e) {
    ...
    class et extends q {
        ...
        _getItemIndex(t) {
            return (
                (this._items = t && t.parentNode ? i.find(".carousel-item", t.parentNode) : []), this._items.indexOf(t)
            )
        }
        _getItemByOrder(t, e) {
            const s = t === Y
    ...
    class bt {
        ...
        dispose() {
            this._isAppended &&
                (B.off(this._element, "mousedown.bs.backdrop"), this._element.remove(), (this._isAppended = !1))
        }
        _emulateAnimation(t) {
        ...
        setElementContent(t, e) {
            if (null !== t)
                return c(e)
                    ...
                    : void (this._config.html
                          ? (this._config.sanitize && (e = Dt(e, this._config.allowList, this._config.sanitizeFn)),
                            (t.innerHTML = e))
                          : (t.textContent = e))
        }
        getTitle() {
    ...
    class Qt extends q {
        ...
        _getConfig(t) {
            return (
                (t = { ...Vt, ...V.getDataAttributes(this._element), ...("object" == typeof t && t ? t : {}) }),
