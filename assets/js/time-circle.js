...
;(function ($) {
    ...
    TC_Instance.prototype.initialize = function (clear_listeners) {
        ...
        this.data.attributes.outer_radius =
            ...
            0.5 * Math.max(this.data.attributes.line_width, this.data.attributes.line_width * this.config.bg_width)
                ...
                if (this.config.animation === "smooth") {
                    if (lastKey !== null && !limited_mode) {
                        if (Math.floor(visible_times.time[lastKey]) > Math.floor(visible_times.old_time[lastKey])) {
                            ...
                            Math.floor(visible_times.time[lastKey]) < Math.floor(visible_times.old_time[lastKey])
                        ) {
